...
public class ModItems {
    ...
    public static final DeferredItem<Item> LEATHER_WOLF_ARMOR = ITEMS.register("leather_wolf_armor", () -> new WolfArmorItem(
        ArmorMaterials.LEATHER, new Item.Properties().durability(24).stacksTo(1))
    );
