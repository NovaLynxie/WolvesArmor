...
public class ModItems {
    ...
    public static final DeferredItem<Item> LEATHER_WOLF_ARMOR = ITEMS.register("leather_wolf_armor", () -> new AnimalArmorItem(
        ArmorMaterials.LEATHER, AnimalArmorItem.BodyType.CANINE, true, new Item.Properties().durability(24).stacksTo(1))
    );
    public static final DeferredItem<Item> MOSSY_WOLF_ARMOR = ITEMS.register("mossy_wolf_armor", () -> new AnimalArmorItem(
        WolfArmorMaterials.MOSS, AnimalArmorItem.BodyType.CANINE, true, new Item.Properties().stacksTo(1))
    );
    ...
    //    WolfArmorMaterials.COPPER, AnimalArmorItem.BodyType.CANINE, true, new Item.Properties().durability(48).stacksTo(1))
    //);
    public static final DeferredItem<Item> TURTLE_WOLF_ARMOR = ITEMS.register("turtle_wolf_armor", () -> new AnimalArmorItem(
        ArmorMaterials.TURTLE, AnimalArmorItem.BodyType.CANINE, true, new Item.Properties().durability(128).stacksTo(1))
    );
    public static final DeferredItem<Item> IRON_WOLF_ARMOR = ITEMS.register("iron_wolf_armor", () -> new AnimalArmorItem(
        ArmorMaterials.IRON, AnimalArmorItem.BodyType.CANINE, true, new Item.Properties().durability(72).stacksTo(1))
    );
    public static final DeferredItem<Item> CHAIN_WOLF_ARMOR = ITEMS.register("chain_wolf_armor", () -> new AnimalArmorItem(
        ArmorMaterials.CHAIN, AnimalArmorItem.BodyType.CANINE, true, new Item.Properties().durability(48).stacksTo(1))
    );
    public static final DeferredItem<Item> GOLD_WOLF_ARMOR = ITEMS.register("gold_wolf_armor", () -> new AnimalArmorItem(
        ArmorMaterials.GOLD, AnimalArmorItem.BodyType.CANINE, true, new Item.Properties().durability(16).stacksTo(1))
    );
    public static final DeferredItem<Item> DIAMOND_WOLF_ARMOR = ITEMS.register("diamond_wolf_armor", () -> new AnimalArmorItem(
        ArmorMaterials.DIAMOND, AnimalArmorItem.BodyType.CANINE, true, new Item.Properties().durability(256).stacksTo(1))
    );
    public static final DeferredItem<Item> NETHERITE_WOLF_ARMOR = ITEMS.register("netherite_wolf_armor", () -> new AnimalArmorItem(
        ArmorMaterials.NETHERITE, AnimalArmorItem.BodyType.CANINE, true, new Item.Properties().durability(512).stacksTo(1))
    );
